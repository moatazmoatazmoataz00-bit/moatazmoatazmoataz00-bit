...
class GameClient {
  ...
  connect() {
    return new Promise((resolve, reject) => {
      this.socket = io("https://trivia-backend-production-7113.up.railway.app");
...
document.addEventListener('DOMContentLoaded', async () => {
  try {
    ...
    console.warn('[APP] Running in offline mode - static pages will load');
    // Setup error handlers even without connection
    setupErrorHandlers();
  }
});
