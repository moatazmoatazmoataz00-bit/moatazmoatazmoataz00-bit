...
document.addEventListener('DOMContentLoaded', () => {
  ...
  createRoomBtn.addEventListener('click', () => {
    ...
    if (!gameClient.socket || !gameClient.socket.connected) {
      usernameError.textContent = 'Unable to connect to server. Please check your connection and try again.';
      return;
    }
  ...
  confirmJoinBtn.addEventListener('click', () => {
    ...
    if (!gameClient.socket || !gameClient.socket.connected) {
      roomCodeError.textContent = 'Unable to connect to server. Please check your connection and try again.';
      return;
    }
